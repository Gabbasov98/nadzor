    ...
    function updateSlides() {
        ...
        for (var i = 0; i < slidesLength; i += 1) {
            ...
            if (params.slidesPerView === 'auto') {
                ...
                var currentMsKitTransform = slide[0].style.msTransform;
                if (currentTransform) {
                ...
                if (currentMsKitTransform) {
                    slide[0].style.msTransform = 'none';
                }
                ...
                if (currentMsKitTransform) {
                    slide[0].style.msTransform = currentWebKitTransform;
                }
